...
const features = [
    {
        ...
        title: "Skilled Team",
        description: "Our experienced craftsmen and designers work with precision and passion, ensuring every cabinetry project reflects unmatched quality and attention to detail."
    },
    {
        id: 2,
        imgSrc: "/images/features/Give-Women's-Rights.svg",
        title: "Trusted Partnerships",
        description: "We build lasting relationships with our clients through honesty, reliability, and a commitment to delivering exceptional results on every order."
    },
    {
        id: 3,
        imgSrc: "/images/features/live-chat.svg",
        title: "Clear Communication",
        description: "From concept to completion, we keep you informed at every stage, guaranteeing a smooth, transparent, and stress-free experience."
    }
];
