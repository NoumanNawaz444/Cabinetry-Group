...
const Header: React.FC = () => {
  ...
  return (
    <header
      className={`fixed h-24 top-0 py-1 z-50 w-full bg-transparent min-h-[120px] dark:bg-semidark transition-all ${sticky ? "shadow-lg dark:shadow-darkmd bg-white " : "shadow-none bg-white "}`}
    >
