      ...
      <div className="container lg:max-w-screen-xl md:max-w-screen-md dark:text-black mx-auto grid grid-cols-1 lg:grid-cols-12 py-40">
        ...
        >
          ...
          <p className="mb-8 pb-2 text-gray">
            At Cabinetry Group, our journey began with a vision to combine timeless craftsmanship
            with modern design innovation. Over the years, we’ve grown into a trusted name in the
            cabinetry industry, delivering precision-built products and exceptional customer experiences
