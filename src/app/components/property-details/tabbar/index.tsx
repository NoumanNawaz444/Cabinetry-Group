...
type TabLabel =
  ...
  | 'Office Cabinets'
  | 'Vinyl Doors Project'
  | 'Glass & Aluminium Cabinets';

// Define the content object with explicit types
const content: Record<TabLabel, TabContent> = {
    'Kitchen Makeover': {
        title: 'Modern Kitchen Transformation',
        description: 'A complete kitchen renovation featuring custom cabinets, smart storage solutions, and premium finishes.',
        features: [
            'Custom Cabinetry',
            'Island Unit',
            'Pull-Out Drawers',
        ...
        image: '/images/tabbar/kitchen-makeover.jpg'
    },
    'Wardrobe Installation': {
        title: 'Stylish Wardrobe Solutions',
        description: 'Designed and installed sleek, space-saving wardrobes with sliding doors and high-quality materials.',
        features: [
            'Sliding Doors',
            'Built-in Shelves',
            'LED Lighting',
        ...
        image: '/images/tabbar/wardrobe-installation.jpg'
    },
    'Office Cabinets': {
        title: 'Custom Office Cabinetry',
        description: 'Optimized office spaces with modular cabinetry, maximizing storage and organization.',
        features: [
            'File Storage',
            'Display Shelves',
            'Modular Design',
        ...
        image: '/images/tabbar/office-cabinets.jpg'
    },
    'Vinyl Doors Project': {
        title: 'Premium Vinyl Door Installation',
        description: 'Installed high-quality vinyl thermolaminated doors for kitchens and wardrobes with a flawless finish.',
        features: [
            'Durable Vinyl',
            'Custom Sizes',
            'Modern Design',
        ...
        image: '/images/tabbar/vinyl-doors.jpg'
    },
    'Glass & Aluminium Cabinets': {
        title: 'Aluminium Glass Cabinetry',
        description: 'Sophisticated aluminium and glass cabinets for modern interiors, combining style with durability.',
        features: [
            'Glass Panels',
            'Aluminium Frames',
            'Custom Layouts',
        ...
        image: '/images/tabbar/glass-aluminium.jpg'
    }
};
...
const tabs: { label: TabLabel; icon: string }[] = [
    { label: 'Kitchen Makeover', icon: 'mdi:chef-hat' },
    { label: 'Wardrobe Installation', icon: 'mdi:wardrobe' },
    { label: 'Office Cabinets', icon: 'mdi:desk' },
    { label: 'Vinyl Doors Project', icon: 'mdi:door' },
    { label: 'Glass & Aluminium Cabinets', icon: 'mdi:glass-fragile' }
];
...
const [activeTab, setActiveTab] = useState<TabLabel>('Kitchen Makeover');
