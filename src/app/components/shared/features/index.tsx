                ...
                <div className="flex lg:flex-row flex-col lg:gap-0 gap-8 justify-between">
                    ...
                    <div className='flex-1 '>
                        <div className="lg:pl-20 flex flex-col justify-center h-full">
                            <p className='mb-8 md:mb-3.75 text-4xl font-bold text-midnight_text dark:text-white sm:text-start text-center' data-aos="fade-left">Why People Choose <span className='font-extrabold '> Cabinetry Group!</span> </p>
                            {pageData.map(feature => (
                                <div key={feature.id} className='flex sm:flex-row flex-col w-full mb-8 md:mb-3.75 sm:justify-start items-center justify-center sm:text-start text-center sm:items-center gap-8' data-aos="fade-left" data-aos-delay="100">
                                    <div className="bg-primary/20 p-4  rounded-full flex justify-center items-center ">
                                        <Image
                                            src={feature.imgSrc}
                                            alt={feature.title}
                                            height={78}
                                    ...
                                    <div className='flex-col w-[calc(100%-112px)]'>
